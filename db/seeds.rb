...
event1 = Event.create(title: 'first', start_date: '07/07/07', end_date: '09/09/07', code: '#DES', is_ended: true , user_id: user1.id)
...
question1 = Question.create!( body: 'Lorem ipsum dolor sit amet, consectetuer adipiscin', user_id: user1.id, event_id: event1.id, answered: true, vote: '0')
question2 = Question.create!( body: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec qu', user_id: user1.id, event_id: event1.id, answered: true, vote: '0')
question3 = Question.create!( body: 'question 3', user_id: user1.id, event_id: event1.id, answered: true,  vote: '0')
